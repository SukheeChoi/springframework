...
//		session.removeAttribute("sessionMid");
	...
	@RequestMapping(value="/loginAjax", produces="application/json; UTF-8")
	@ResponseBody
	...
	@RequestMapping(value="/logoutAjax", produces="application/json; UTF-8")
	@ResponseBody
...
//		session.invalidate();
	...
	public Ch08InputForm getCh09InputForm() {
		log.info("실행");
