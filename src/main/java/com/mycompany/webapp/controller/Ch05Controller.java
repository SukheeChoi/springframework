...
public class Ch05Controller {
	...
	public String getHeaderValue(HttpServletRequest request, @RequestHeader("User-Agent") String userAgennt) {
		log.info("실행");
...
//		cookie.setDomain("127.0.0.1");
		...
		cookie.setMaxAge(60*30);      //이 시간동안에만 전송
		cookie.setHttpOnly(false); //JavaScript에서 못 읽게함      
		cookie.setSecure(false);  //true: https://만 전송, false: https:// 또는 http:// 모두 전송
