   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card-body">
            ...
            <%-- <a href="${pageContext.request.contextPath}/ch02/method?bkind=free&bno=1" class="btn btn-info btn-sm" >GET 방식</a> --%>
         ...
         <script>
            function requestGet() {
                // window.location.href = "${pageContext.request.contextPath}/ch02/method?bkind=free&bno=1";
               $.ajax({
